        ...
        <table id="all-plugins-table" class="widefat">
          <tbody class="plugins">
            <tr>
            	<td>
            	  <label for="">API: </label>
            	  <select name="teleportd_cache[<?php print $cache_num ?>][api_selected]" class="disable_onchange" >
            	  ...
            	  <label for="">API Key (not needed) </label>
            ...
            <tr class="active">
              <td class="desc">
                <p><input type="text" name="teleportd_cache[<?php print $cache_num ?>][search_name]" value="<?php print ($cache_settings[search_name] ? $cache_settings[search_name] : $cache_settings['api_selected']) ?>" class="regular-text disable_onchange" /></p>
              </td>
          	  <th scope="row">
            ...
            <tr class="active">
              <td class="desc">
            	  <select name="teleportd_cache[<?php print $cache_num ?>][only_with_pics]" class="disable_onchange" >
            ...
            <tr class="active">
              <td class="desc">
            	  <select name="teleportd_cache[<?php print $cache_num ?>][skip_retweets]" class="disable_onchange" >
            ...
            <tr class="active">
              <td class="desc">
                <p><input type="text" name="teleportd_cache[<?php print $cache_num ?>][string]" value="<?php print $cache_settings[string] ?>" class="regular-text disable_onchange" /></p>
              </td>
          	  <th scope="row">
            ...
            <tr class="active">
              <td class="desc">
                <p><input type="text" name="teleportd_cache[<?php print $cache_num ?>][period]" value="<?php print $cache_settings[period] ?>" class="regular-text disable_onchange" /></p>
              </td>
          	  <th scope="row">
            ...
            <tr class="active">
              <td class="desc">
                <p><input type="text" name="teleportd_cache[<?php print $cache_num ?>][location]" value="<?php print $cache_settings[location] ?>" class="regular-text disable_onchange" /></p>
              </td>
          	  <th scope="row">
              ...
              <td class="desc">
            	  ...
            	  <select name="teleportd_cache[<?php print $cache_num ?>][cron_interval]" >
            ...
            <tr>
            	<td>
            	  ...
            	  <label for="">API Key: </label>
            		<input type="text" name="teleportd_cache[<?php print $cache_num ?>][api_authentication]" value="<?php print $cache_settings[api_authentication] ?>" class="regular-text disable_onchange" id="teleportd_api" /> 
            		<!-- a class="button-secondary" id="test_api" href="javascript:test_api(<?php print $cache_num ?>);">Test API</a> <div id="test_response"></div -->
            	</td>
          	  <th scope="row">
            	</th>
